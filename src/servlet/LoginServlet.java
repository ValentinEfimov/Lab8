...
// Задать кодировку HTTP-ответа
        ...
        // Вывести форму
        pw.println("<form action='/LAB88_war_exploded/' method='post'>Enter the name: <input type='text' name='name' value=''><input type='submit' value='Connect to the chat'>");
...
// Иначе вместо символов будет абракадабра
        ...
        if (errorMessage!=null) {
            ...
            response.sendRedirect(response.encodeRedirectURL("/LAB88_war_exploded/")); //здесь???
        }
    }
